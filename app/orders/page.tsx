...
import { ArrowLeft, Package, Clock, CheckCircle2, Truck, ChevronRight, RotateCcw, ShoppingBag } from "lucide-react"
...
const sampleOrders: Order[] = [
  {
    ...
    total: 245,
    items: [
      { id: 1, name: "Amul Milk", quantity: "1L", price: 65, image: "/amul-milk-packet-white-background.jpg" },
      { id: 2, name: "Brown Bread", quantity: "400g", price: 45, image: "/brown-bread-loaf-white-background.jpg" },
      { id: 3, name: "Farm Eggs", quantity: "12 pcs", price: 85, image: "/farm-eggs-brown-white-background.jpg" },
    ],
  ...
  },
  {
    ...
    total: 520,
    items: [
      { id: 4, name: "Butter", quantity: "500g", price: 280, image: "/butter-block-yellow-white-background.jpg" },
      { id: 5, name: "Curd", quantity: "400g", price: 45, image: "/curd-yogurt-cup-white-background.jpg" },
    ],
...
export default function OrdersPage() {
  ...
  const filteredOrders = (() => {
    switch (activeTab) {
      case "active":
        return orders.filter((order) => order.status === "in-transit" || order.status === "preparing")
      case "completed":
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-xs text-muted-foreground">
                    ...
                    {order.status === "delivered"
                      ? `${t("orders.deliveredIn")} ${order.deliveryTime}`
                      : `Est. ${order.deliveryTime}`}
                  </p>
                </div>
